...
```
aws s3 cp ./scenarios s3://crcsim-exp-fqhc-diag-and-screen-compliance-interaction/scenarios --recursive
```
...
We used the S3 console to create the `crcsim-exp-fqhc-diagnostic-and-screening-compliance-interaction` bucket to store output files generated by simulation jobs.
