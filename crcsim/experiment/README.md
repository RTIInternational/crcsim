...
### 3. Create Combined Parameter Files

The script `combine_tests.py` combines two tests in a parameters file and adds the combined test. This script is used to create the combined test scenarios.

Run python combine_tests.py --param_file=parameters.json --test_1=<test_name_1> --test_2=<test_name_2> --how=<serial/parallel>

If you want to create a modified output parameters file, use the --output_file argument.  

Run python combine_tests.py --param_file=parameters.json --test_1=<test_name_1> --test_2=<test_name_2> --how=<serial/parallel> --output_file=<modified_parameters.json>

### 4. Prepare the Experiment Files
...
### 5. Upload the Experiment Files to S3
...
```
aws s3 cp ./scenarios s3://crcsim-exp-test-combinations/scenarios --recursive
```
