...
def combine_tests_in_params(
    params: dict, test1: str, test2: str, how: TestCombiningMethod = TestCombiningMethod.PARALLEL
) -> dict:
    """
    ...
    combined["proportion_perforation"] = t1["proportion_perforation"] + t2["proportion_perforation"]
